                ...
                <div style={{ background: "#1a1a1a", borderRadius: 28, overflow: "hidden" }}>
                  ...
                  <div style={{ background: "#fdf8f5", height: 500, padding: "20px 16px", overflowY: "hidden" }}>
                    ...
                    <div style={{ background: "white", borderRadius: 16, padding: "12px 14px", boxShadow: "0 2px 10px rgba(0,0,0,0.05)", display: "flex", alignItems: "center", gap: 10 }}>
                      ...
                      <div style={{ width: 24, height: 24, borderRadius: "50%", display: "flex", alignItems: "center", justifyContent: "center", fontSize: 11, color: "white" }}><img src='/svg/landingpagecalendar/heart-cardiogram 1.svg'/></div>
                    </div>
                    <div style={{ background: "white", borderRadius: 16, margin: "12px 0", padding: "12px 14px", boxShadow: "0 2px 10px rgba(0,0,0,0.05)", display: "flex", alignItems: "center", gap: 10 }}>
                      ...
                      <div style={{ width: 24, height: 24, borderRadius: "50%", display: "flex", alignItems: "center", justifyContent: "center", fontSize: 11, color: "white" }}><img src='/svg/landingpagecalendar/electricity 1.svg'/></div>
                    </div>
                    <div style={{ background: "white", borderRadius: 16, margin: "12px 0", padding: "12px 14px", boxShadow: "0 2px 10px rgba(0,0,0,0.05)", display: "flex", alignItems: "center", gap: 10 }}>
                      <div style={{ flex: 1 }}>
                        <div style={{ fontFamily: "'DM Sans', sans-serif", fontSize: 11, fontWeight: 600, color: "#3d2b26" }}>Anonim savol yo’llash </div>
                      </div>
                      <div style={{ width: 24, height: 24, borderRadius: "50%", display: "flex", alignItems: "center", justifyContent: "center", fontSize: 11, color: "white" }}><img src='/svg/landingpagecalendar/boxicons_message-bubble-heart-filled.svg'/></div>
                    </div>
                  </div>
                </div>
              </div>
