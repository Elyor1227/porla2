  ...
  return (
    <aside style={{ width:240, flexShrink:0, background:T.white, borderRight:`1px solid ${T.border}`, display:"flex", flexDirection:"column", minHeight:"100vh", position:"sticky", top:0 }}>
        ...
        <div style={{ display:"flex", alignItems:"center", gap:10 }}>
          <img src={LOGO_BLACK} alt="Miila" style={{ height:32, width:"auto", maxWidth:150, objectFit:"contain" }} />
        </div>
      </div>
      ...
      <div style={{ padding:"12px 20px 24px", borderTop:`1px solid ${T.border}` }}>
        ...
        {!user?.isPro && (
          <button onClick={openPaymentBot}
            ...
            <img width={24} height={24} src={LOGO_MARK} alt="" style={{ objectFit:"contain" }} /> Premium xaridi
          </button>
        )}
      </div>
    </aside>
  ...
  return (
    <>
      <header style={{ background:T.white, borderBottom:`1px solid ${T.border}`, padding:"0 20px", height:60, display:"flex", alignItems:"center", justifyContent:"space-between", position:"sticky", top:0, zIndex:100, boxShadow:"0 2px 12px rgba(34,18,25,.06)" }}>
        <div style={{ display:"flex", alignItems:"center", gap:10 }}>
          <img src={LOGO_BLACK} alt="Miila" style={{ height:28, width:"auto", maxWidth:130, objectFit:"contain" }} />
        </div>
      ...
      <div style={{ width:"100%", maxWidth:420 }}>
        <div style={{ textAlign:"center", marginBottom:32 }}>
          <div style={{ display:"flex", justifyContent:"center", margin:"0 auto 16px" }}>
            <img src={LOGO_BLACK} alt="Miila" style={{ height:64, width:"auto", maxWidth:200, objectFit:"contain" }} />
          </div>
        ...
        <div style={{ padding:"24px" }}>
          {(lessonData.isLocked) ? (
            ...
            <div style={{ textAlign:"center", padding:"40px 20px" }}>
              ...
              {!userIsPro && (
                <Btn variant="gold" size="lg" onClick={openPaymentBot}> <img width={24} src={LOGO_MARK} alt="" /> Premiumga o'tish</Btn>
              )}
            </div>
          ) : (
            <>
        ...
        <div style={{ display:"flex", flexDirection:"column", gap:10 }}>
          ...
          {!userIsPro && lessons.length > 1 && (
            <div style={{ background:"linear-gradient(135deg,#fffbeb,#fef9ef)", border:"1.5px solid rgba(233,168,37,.3)", borderRadius:18, padding:"18px 20px", textAlign:"center", marginTop:8 }}>
              ...
              <Btn variant="gold" size="sm" onClick={openPaymentBot}>Premiumga o'tish <img width={24} src={LOGO_MARK} alt="" /></Btn>
            </div>
          )}
        </div>
      )}
        ...
        <>
          ...
          <div style={{ background:"linear-gradient(145deg,#1e1015,#2d1520)", borderRadius:24, padding:"24px" }}>
            <div style={{ display:"flex", alignItems:"center", justifyContent:"space-between", marginBottom:20, flexWrap:"wrap", gap:12 }}>
              <div>
                <p style={{ fontFamily:serif, fontSize: isLg ? 24 : 20, fontWeight:700, color:T.white, margin:"0 0 4px" }}> <img width={28} src={LOGO_MARK} alt="premium" /> Premium Darslar</p>
                <p style={{ fontFamily:sans, fontSize:13, color:"rgba(255,255,255,.55)", margin:0 }}>Premium rejimga o'ting va barchasini oching</p>
              </div>
              <Btn variant="gold" onClick={openPaymentBot}>Premiumga o'tish <img style={{ backgroundColor: 'rgba(255, 255, 255, 0.55)', borderRadius:12 }} width={30} src={LOGO_MARK} alt="premium" /></Btn>
            </div>
        ...
        <div>
          ...
          {!user?.isPro && (
            <div style={{ background:"linear-gradient(135deg,#fffbeb,#fef9ef)", border:"1.5px solid rgba(233,168,37,.3)", borderRadius:20, padding:"18px 20px" }}>
              <div style={{ display:"flex", gap:14, alignItems:"center" }}>
                <div style={{ width:48, height:48, borderRadius:14, background:"rgba(233,168,37,.1)", display:"flex", alignItems:"center", justifyContent:"center", fontSize:22, flexShrink:0 }}> <img width={28} src={LOGO_MARK} alt="premium" /> </div>
                <div style={{ flex:1 }}>
          ...
          {user?.isPro && (
            <div style={{ background:"linear-gradient(135deg,#f0fdf4,#fbfcf8)", border:"1.5px solid rgba(16,185,129,.3)", borderRadius:20, padding:"18px 20px" }}>
              <div style={{ display:"flex", gap:14 }}>
                <div style={{ width:48, height:48, borderRadius:14, background:"rgba(16,185,129,.1)", display:"flex", alignItems:"center", justifyContent:"center", fontSize:22, flexShrink:0 }}><img width={24} src={LOGO_MARK} alt="" /></div>
                <div style={{ flex:1 }}>
  ...
  if (!authChecked) return (
    <div style={{ minHeight:"100vh", display:"flex", alignItems:"center", justifyContent:"center", background:T.cream, flexDirection:"column", gap:20 }}>
      ...
      <div style={{ width:48, height:48, borderRadius:16, display:"flex", alignItems:"center", justifyContent:"center" }}>
        <img src={LOGO_MARK} alt="" width={40} height={40} style={{ objectFit:"contain" }} />
      </div>
      <div style={{ width:32, height:32, border:"3px solid rgba(214,79,110,.2)", borderTopColor:T.rose, borderRadius:"50%", animation:"spin .7s linear infinite" }}/>
    </div>
  );
