...
//  * ╔══════════════════════════════════════════════════════╗
//  * ║         PORLA — Admin Panel                          ║
//  * ║   Route: /admin  (faqat isAdmin:true uchun)          ║
//  * ╚══════════════════════════════════════════════════════╝
//  *
//  * App.jsx ga qo'shing:
//  *   <Route path="/admin/*" element={<AdminApp />} />
//  *
//  * api.js dan foydalanadi — adminApi qismi pastda
//  */
...
//   setPro:         (id, isPro, months) => req("PATCH", `/admin/users/${id}/pro`, { isPro, months }),
//   blockUser:      (id, isBlocked) => req("PATCH",  `/admin/users/${id}/block`, { isBlocked }),
//   deleteUser:     (id)            => req("DELETE", `/admin/users/${id}`),
//   notifyUser:     (id, d)         => req("POST",   `/admin/users/${id}/notify`, d),
//   broadcast:      (d)             => req("POST",   "/admin/broadcast", d),
//   courses:        ()              => req("GET",    "/admin/courses"),
//   createCourse:   (d)             => req("POST",   "/admin/courses", d),
//   updateCourse:   (id, d)         => req("PATCH",  `/admin/courses/${id}`, d),
//   deleteCourse:   (id)            => req("DELETE", `/admin/courses/${id}`),
//   lessons:        (cId)           => req("GET",    `/admin/courses/${cId}/lessons`),
//   createLesson:   (cId, d)        => req("POST",   `/admin/courses/${cId}/lessons`, d),
//   updateLesson:   (cId, lId, d)   => req("PATCH",  `/admin/courses/${cId}/lessons/${lId}`, d),
//   deleteLesson:   (cId, lId)      => req("DELETE", `/admin/courses/${cId}/lessons/${lId}`),
// };
...
//         <Input label="Video URL (ixtiyoriy)" value={lForm.videoUrl} onChange={e=>setLForm(f=>({...f,videoUrl:e.target.value}))} placeholder="https://youtube.com/..."/>
